...
function createModel(opt)
	...
	local B  = ConvLayers(512,1024)(MaxPooling(2,2)(D5))

	local U5 = ConvLayers(1024,512)(Join(1,3)({D5, ReLU(true)(UpConvolution(1024,512, 2,2,2,2)(B))}))
	local U4 = ConvLayers( 512,256)(Join(1,3)({D4, ReLU(true)(UpConvolution(512 ,256, 2,2,2,2)(U5))}))
