...
function createModel(opt)
	...
	dropout = 0.1
	local D1 = ConvLayers(nbChannels,32, dropout)(input)
	local D2 = ConvLayers(32,64, dropout)(MaxPooling(2,2)(D1))
	local D3 = ConvLayers(64,128, dropout)(MaxPooling(2,2)(D2))
	local D4 = ConvLayers(128,256, dropout)(MaxPooling(2,2)(D3))

	local B = ConvLayers(256,512, dropout)(MaxPooling(2,2)(D4))

	local U4 = ConvLayers(512,256, dropout)(Join(1,3)({ D4, ReLU(true)(UpConvolution(512,256, 2,2,2,2)(B)) }))
	local U3 = ConvLayers(256,128, dropout)(Join(1,3)({ D3, ReLU(true)(UpConvolution(256,128, 2,2,2,2)(U4)) }))
	local U2 = ConvLayers(128,64, dropout)(Join(1,3)({ D2, ReLU(true)(UpConvolution(128,64, 2,2,2,2)(U3)) }))
	local U1 = ConvLayers(64,32, dropout)(Join(1,3)({ D1, ReLU(true)(UpConvolution(64,32, 2,2,2,2)(U2))   }))
	...
	return net,'unet_spacialdropout'
end
